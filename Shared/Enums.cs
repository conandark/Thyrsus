public enum HEADER : ushort
{
    ...
    HEADER_AC_REFUSE_LOGIN_SSO = 0x83e,
...
public enum SPECIAL_HEADER : ushort
{
    HEADER_CZ_ENTER = 0x9b,
    HEADER_CZ_REQUEST_TIME = 0x89,
    HEADER_CZ_REQUEST_ACT = 0x190,
    HEADER_CZ_REQUEST_MOVE = 0xa7,
    HEADER_CZ_REQUEST_CHAT = 0xf3,
    HEADER_CZ_REQNAME = 0x8c,
    HEADER_CZ_CHANGE_DIRECTION = 0x85,
    HEADER_CZ_ITEM_PICKUP = 0xf5,
    HEADER_CZ_ITEM_THROW = 0x116,
    HEADER_CZ_USE_ITEM = 0x9f,
    HEADER_CZ_MOVE_ITEM_FROM_BODY_TO_STORE = 0x94,
    HEADER_CZ_MOVE_ITEM_FROM_STORE_TO_BODY = 0xf7,
    HEADER_CZ_CLOSE_STORE = 0x193,
    HEADER_CZ_USE_SKILL = 0x72,
    HEADER_CZ_USE_SKILL_TOGROUND = 0x113,
    HEADER_CZ_USE_SKILL_TOGROUND_WITHTALKBOX = 0x7e,
    HEADER_CZ_REQNAME_BYGID = 0xa2,
};
...
public enum Clienttype
{
    ...
    CLIENTTYPE_THAI,
    CLIENTTYPE_LOCAL,
    CLIENTTYPE_JAPAN_SAKRAY,
    CLIENTTYPE_THAI_SAKRAY,
    CLIENTTYPE_TAIWAN_SAKRAY,
    CLIENTTYPE_INDONESIA,
    CLIENTTYPE_INDONESIA_SAKRAY,
    CLIENTTYPE_ENGLISH_SAKRAY,
    CLIENTTYPE_PHILIPPINE,
    CLIENTTYPE_MALAYSIA,
    CLIENTTYPE_SINGAPORE,
    CLIENTTYPE_PHILIPPINE_SAKRAY,
    CLIENTTYPE_THAI_FREE,
    CLIENTTYPE_GERMANY,
    CLIENTTYPE_INDIA,
    CLIENTTYPE_BRAZIL,
    CLIENTTYPE_AUSTRALIA,
    CLIENTTYPE_KOREAN_PK,
    CLIENTTYPE_RUSSIA,
    CLIENTTYPE_VIETNAM,
    CLIENTTYPE_PHILIPPINE_PK,
    CLIENTTYPE_JAPAN_PK,
    CLIENTTYPE_THAI_PK,
    CLIENTTYPE_CHILE,
    CLIENTTYPE_FRANCE,
    CLIENTTYPE_VIETNAM_PK,
    CLIENTTYPE_VIETNAM_SAKRAY,
    CLIENTTYPE_INDONESIA_PK,
    CLIENTTYPE_UAE,
    MAX_CLIENTTYPE
};
...
{
    REFUSE_INVALID_ID,
    REFUSE_INVALID_PASSWD,
    REFUSE_ID_EXPIRED,
    ACCEPT_ID_PASSWD,
    REFUSE_NOT_CONFIRMED,
    REFUSE_INVALID_VERSION,
    REFUSE_BLOCK_TEMPORARY,
    REFUSE_BILLING_NOT_READY,
    REFUSE_NONSAKRAY_ID_BLOCKED,
    REFUSE_BAN_BY_DBA,
    REFUSE_EMAIL_NOT_CONFIRMED,
    REFUSE_BAN_BY_GM,
    REFUSE_TEMP_BAN_FOR_DBWORK,
    REFUSE_SELF_LOCK,
    REFUSE_NOT_PERMITTED_GROUP,
    REFUSE_WAIT_FOR_SAKRAY_ACTIVE,
    REFUSE_NOT_CHANGED_PASSWD,
    REFUSE_BLOCK_INVALID,
    REFUSE_WARNING,
    REFUSE_NOT_OTP_USER_INFO,
    REFUSE_OTP_AUTH_FAILED,
    REFUSE_SSO_AUTH_FAILED,
    REFUSE_NOT_ALLOWED_IP_ON_TESTING,
    REFUSE_OVER_BANDWIDTH,
    REFUSE_OVER_USERLIMIT,
    REFUSE_UNDER_RESTRICTION,
    REFUSE_BY_OUTER_SERVER,
    REFUSE_BY_UNIQUESERVER_CONNECTION,
    REFUSE_BY_AUTHSERVER_CONNECTION,
    REFUSE_BY_BILLSERVER_CONNECTION,
    REFUSE_BY_AUTH_WAITING,
    REFUSE_DELETED_ACCOUNT = 99,
    REFUSE_ALREADY_CONNECT,
    REFUSE_TEMP_BAN_HACKING_INVESTIGATION,
    REFUSE_TEMP_BAN_BUG_INVESTIGATION,
    REFUSE_TEMP_BAN_DELETING_CHAR,
    REFUSE_TEMP_BAN_DELETING_SPOUSE_CHAR,
    REFUSE_USER_PHONE_BLOCK,
    ACCEPT_LOGIN_USER_PHONE_BLOCK,
    ACCEPT_LOGIN_CHILD,
    REFUSE_IS_NOT_FREEUSER,
    REFUSE_INVALID_ONETIMELIMIT,
    REFUSE_NOT_CHANGE_ACCOUNTID = 240,
    REFUSE_NOT_CHANGE_CHARACTERID,
    REFUSE_SSO_INVALID_TOKEN = 5011,
    REFUSE_SSO_BLOCK_USER,
    REFUSE_SSO_GAME_APPLY,
    REFUSE_SSO_INVALID_GAMENUM,
    REFUSE_SSO_INVALID_USER,
    REFUSE_SSO_OTHERS,
    REFUSE_SSO_INVALID_AGE
};

public enum BanCodes
{
    BAN_UNFAIR,
    BAN_SERVER_SHUTDOWN,
    BAN_ANOTHER_LOGIN,
    BAN_DETECTED_SPEEDHACK,
    BAN_PC_OVERFLOW,
    BAN_UNDER_AGE,
    BAN_NOT_SETTLED,
    BAN_ACCOUNT_BUSY,
    BAN_INFORMATION_REMAINED,
    BAN_IP_OVERFLOW,
    BAN_PAY_OUT,
    BAN_PAY_SUSPEND,
    BAN_PAY_CHANGE,
    ...
    BAN_JAPAN_REFUSE1,
    BAN_JAPAN_REFUSE2,
    BAN_INFORMATION_REMAINED_ANOTHER_ACCOUNT,
    BAN_PC_IP_UNFAIR = 100,
    BAN_PC_IP_COUNT_ALL,
    BAN_PC_IP_COUNT,
    BAN_GRAVITY_MEM_AGREE,
    BAN_GAME_MEM_AGREE,
    BAN_HAN_VALID,
    BAN_PC_IP_LIMIT_ACCESS,
    BAN_OVER_CHARACTER_LIST,
    BAN_IP_BLOCK,
    BAN_INVALID_PWD_CNT,
    BAN_NOT_ALLOWED_JOBCLASS,
    BAN_END = 255
};
